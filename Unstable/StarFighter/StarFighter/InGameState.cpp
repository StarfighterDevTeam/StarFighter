	...
	if ((*CurrentGame).getHudFocusedItem() != NULL)
	{
		...
		if (equip_index_ == NBVAL_Equipment)
		{
			...
			(*CurrentGame).updateHud((*CurrentGame).playerShip->armor, (*CurrentGame).playerShip->armor_max, (*CurrentGame).playerShip->shield, (*CurrentGame).playerShip->shield_max, (*CurrentGame).playerShip->getMoney(), (*CurrentGame).playerShip->graze_count,
				...
				equip_index_, tmp_weapon->display_name, tmp_weapon->level, tmp_weapon->credits, -1, -1, -1, -1, -1, tmp_weapon->ammunition->damage, false, tmp_weapon->ammunition->speed.y, tmp_weapon->ammunition->Pattern.currentPattern, tmp_weapon->multishot, 
		...
		else
		{
			...
			if (!tmp_equipment->bot)
			{
				(*CurrentGame).updateHud((*CurrentGame).playerShip->armor, (*CurrentGame).playerShip->armor_max, (*CurrentGame).playerShip->shield, (*CurrentGame).playerShip->shield_max, (*CurrentGame).playerShip->getMoney(),
					...
					tmp_equipment->shield, tmp_equipment->shield_regen, tmp_equipment->damage, tmp_equipment->bot);
			}
			else
			{
				...
				(*CurrentGame).updateHud((*CurrentGame).playerShip->armor, (*CurrentGame).playerShip->armor_max, (*CurrentGame).playerShip->shield, (*CurrentGame).playerShip->shield_max, (*CurrentGame).playerShip->getMoney(),
					...
					tmp_equipment->bot->shield_max, tmp_equipment->bot->shield_regen, tmp_equipment->bot->weapon->ammunition->damage, tmp_equipment->bot, tmp_equipment->bot->weapon->ammunition->speed.y,
