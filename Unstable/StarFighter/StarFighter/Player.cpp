...
void Player::Init()
{
	m_collider_type = GameObjectType::PlayerObject;
	m_moving = false;
...
Player::Player(sf::Vector2f position, sf::Vector2f speed, std::string textureName, sf::Vector2f size, sf::Vector2f origin, int frameNumber, int animationNumber) : GameObject(position, speed, textureName, size, origin, frameNumber, animationNumber)
{
	this->Init();
}

Player::Player(sf::Vector2f position, sf::Vector2f speed, std::string textureName, sf::Vector2f size) : GameObject(position, speed, textureName, size)
{
	this->Init();
}
...
void Player::ManageHud(sf::Time deltaTime)
{
	//Hud
	m_is_asking_SFUnitPanel = false;
	m_is_asking_SFContextPanel_string = "";
...
bool Player::ScreenBorderContraints()
{
...
void Player::IdleDecelleration(sf::Time deltaTime)
{
	//idle decceleration
	if (!m_movingX)
	{
...
void Player::ManageAcceleration(sf::Vector2f inputs_direction)
{
...
void Player::MaxSpeedConstraints()
{
...
void Player::PlayStroboscopicEffect(Time effect_duration, Time time_between_poses)
{
...
int Player::SavePlayer(Player* player)
{
	...
	{
		data << "Save ";// << player->m_speed.x << endl;
...
bool Player::LoadPlayer(Player* player)
{
...
void Player::HoverObject(GameObject* object)
{
