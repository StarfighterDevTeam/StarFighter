...
Building* Building::CreateBuilding(string name)
{
	...
	if (!(*CurrentGame).m_buildingConfig[name][BuildingData_StarshipProduction2].empty() && (*CurrentGame).m_buildingConfig[name][BuildingData_StarshipProduction2].compare("0") != 0)
	{
