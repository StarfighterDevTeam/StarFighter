...
#define SWORDFISH_LATERAL_ACCELERATION			100.0f
#define SWORDFISH_DIVE_ACCELERATION				500.0f
#define SWORDFISH_ARCHIMED_ACCELERATION			20.0f
#define SWORDFISH_DECCELERATION_COEF			5000.0f
#define SWORDFISH_MAX_SPEED						600.0f
#define SWORDFISH_MAX_AIRJUMP_LATERAL_SPEED		150.0f
#define SWORDFISH_MAX_DIVE_LATERAL_SPEED		100.0f
#define SWORDFISH_MIN_SPEED						50.0f
#define SWORDFISH_MAX_DIVE_SPEED				500.0f
#define SWORDFISH_DEPTH_DEFAULT					20.f
#define SWORDFISH_DEPTH_MAX						100.f
#define SWORDFISH_GRAVITY_ACCELERATION			20.0f
#define SWORDFISH_AIRJUMP_ACCELERATION			500.0f
#define SWORDFISH_AIRJUMP_HEIGHT_MAX			20.0f
#define SWORDFISH_INITIAL_OFFSET_Y				800.f
