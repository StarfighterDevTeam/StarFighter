...
#define DELAY_FOR_GOAL_FADE_OUT						1.f
...
//BUMPERS DRAWING
#define BUMPER_WIDTH								1
#define BUMPER_STROKE_SIZE							1
#define BUMPER_GLOW_RADIUS							8
#define BUMPER_GLOW_MIN_RADIUS						1
#define BUMPER_GLOW_ANIMATION_DURATION				0.4f
#define BUMPER_INSIDE_ALPHA							100

//GOAL_DRAWING		
#define GOAL_STROKE_SIZE							1
#define GOAL_GLOW_RADIUS							8
#define GOAL_GLOW_MIN_RADIUS						1
#define GOAL_GLOW_ANIMATION_DURATION				0.4f
#define GOAL_INSIDE_ALPHA							100
...
#define IA_DISCOBALL_ANGLERAD_VARIATION_IS_SMALL			0.3f
#define IA_DISTANCE_FOR_SAFE_TACKLE							450
#define IA_DISTANCE_FOR_CLEAR_LINE_OF_FIRE					150
