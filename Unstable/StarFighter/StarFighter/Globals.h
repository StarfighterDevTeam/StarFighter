...
#define USE_FEEDBACK_DECONDENSATION					true
...
#define TEXT_POP_FLUXOR_DISTANCE_NOT_FADED			20
#define TEXT_POP_FLUXOR_DISTANCE_FADE_OUT			10
#define TEXT_POP_FLUXOR_TOTAL_TIME					0.6f

#define TEXT_POP_OFFSET_Y							8
#define TEXT_POP_FLUXOR_OFFSET_Y					24
...
#define MODULE_TRANSFER_DELAY						0.f
