...
//BRAWL
#define SHIP_BRAWL_DURATION							0.05f
#define SHIP_SPEED_ON_BRAWLING						1000.f
...
#define BRAWL_AGAIN_COOLDOWN						0.2f

//RECOVERY
#define RECOVERING_FROM_BRAWL_COOLDOWN				0.4f
...
#define	CARRY_CATCH_ACCELERATION_MALUS				7.f
