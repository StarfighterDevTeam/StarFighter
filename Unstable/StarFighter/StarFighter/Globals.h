...
#define XP_MAX_FIRST_LEVEL								1000
#define XP_MAX_INCREASE_PER_LEVEL						0.50
#define XP_DEATH_MALUS_PERCENTAGE						0.05
#define PLAYER_LEVELING_STATS_MULTIPLIER				0.10
#define ENEMIES_LEVELING_STATS_MULTIPLIER				0.15
#define BOT_STATS_MULTIPLIER							0.30

#define FIRST_LEVEL_ARMOR								1000
#define FIRST_LEVEL_SHIELD								300
#define FIRST_LEVEL_SHIELD_REGEN						100
#define FIRST_LEVEL_COLLISION_DAMAGE					10
#define FIRST_LEVEL_AMMO_DAMAGE							20
