...
#define SCENE_POP_TIME_NOT_FADED						1.0f
#define SCENE_POP_TOTAL_TIME							2.0f
#define DESTRUCTIONS_DISPLAY_OFFSET_Y					450
#define DESTRUCTIONS_DISPLAY_TIME_NOT_FADED				3.0f
#define DESTRUCTIONS_DISPLAY_POP_TOTAL_TIME				5.0f
