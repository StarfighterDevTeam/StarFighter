#ifndef PIXELPERFECTCOLLISION_H_INCLUDED
#define PIXELPERFECTCOLLISION_H_INCLUDED
...
public:
	...
	static bool AreColliding(const sf::Sprite& a, const sf::Sprite& b,
...
#endif // PIXELPERFECTCOLLISION_H_INCLUDED