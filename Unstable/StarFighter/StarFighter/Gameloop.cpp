...
Gameloop::Gameloop()
{
	...
	Ship* player2 = new AIShip(Ship_Alpha, sf::Vector2i(0, 0), 0, Hostility_Enemy, ROE_HoldFire);
	(*CurrentGame).m_onlineShips.push_back(player2);
	(*CurrentGame).addToScene(player2, AIShipLayer, AllyShipObject, false);
