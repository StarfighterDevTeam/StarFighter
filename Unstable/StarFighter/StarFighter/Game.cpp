...
{
	this->hud.Update(m_armor, m_armor_max, m_shield, m_shield_max, m_money, m_graze_count, m_hazard_level, scene_name, level, level_max, xp, xp_max, this->GetPlayerStatsMultiplierForLevel(level), deltaTime, hub, focused_item_type, f_name, f_level, f_max_speed, f_hyperspeed,
