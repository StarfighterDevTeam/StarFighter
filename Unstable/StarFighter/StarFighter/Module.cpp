...
Module::Module(sf::Vector2f position, std::string textureName, sf::Vector2f size, sf::Vector2f origin, int frameNumber, int animationNumber) : FluxEntity(position, textureName, size, origin, frameNumber, animationNumber)
{
	Initialize();
